...
export default function Drop({handleTheme}) {
  return (
    <svg width="24" height="28" onClick={handleTheme} className="header__drop" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
